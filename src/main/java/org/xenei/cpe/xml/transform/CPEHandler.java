 ...
 * Uses a SAX parser.
 * 
 * Works by pushing and popping CPEHandlerBase instance on and off a stack.  Most ContentHandler
 * events are delegated to the CPEHandlerBase at the top of the stack.
 *
 */
public class CPEHandler implements ContentHandler {
	...
	/**
	 * Add a triple to the output stream.
	 * The triple will be in the graph named by the URL
	 ...
	 */
	public void load(InputStream xmlInput, String base)
