...
/**
 * A generic element in the XML document. The generic element in the XML
 * document contains text. This class will capture the text and create a
 * property to add it to the subject handler. The only attribute processed is
...
public class GenericElement extends CPEHandlerBase {
	 ...
	 * @param attributes  the attributes for this generic element.
	 */
	public GenericElement(CPEHandlerBase baseHandler, Resource subject, String uri, String localName,
